Meteor.startup(function () {
	...
	if (Cooperatives.find().count() <= 0) {
		...
		Cooperatives.insert({name: "EcoCitrus", image: "logo_coaf.png", cover: "eco_citrus.jpg", "description": "Uma cooperativa de citricultores com um vasto campo de atuação. A crença em uma agricultura sustentável, ecologicamente correta, socialmente justa e economicamente viável sempre orientou os passos da Ecocitrus – Cooperativa dos Citricultores Ecológicos do Vale do Caí.", address: "Montenegro - RS"});
		Cooperatives.insert({name: "AAPISUL", image: "logo_coaf.png", cover: "AAPISUL.jpeg", "description": "Fundada desde 2007, na cidade de Pilar do Sul-SP com um grupo de 8 agricultores, em 2015 o número total de associados é de 27, que produzem além de mel, outros sub produtos (geléia real,própoles, cera e outros)", address: "Rua Major Euzébio de Moraes Cunha, 312, Fundos, Pilar do Sul"});
	}
